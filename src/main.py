...
# 	map_file = 'maps/2.txt'
# 	experiment = Experiment('map2log/', map_file, 100, 25, guard_move=20, iterations=100)
# 	experiment.run()
#
# 	map_file = 'maps/4.txt'
# 	experiment = Experiment('map4log/', map_file, 100, 25, guard_move=20, iterations=100)
# 	experiment.run()

	map_file = 'maps/5.txt'
	experiment = Experiment('map5log/', map_file, 1000, 25, guard_move=20, iterations=100)
	experiment.run()
